      ...
      child: TextField(
        ...
        onTap: () async {
          ...
          if (pickdate == null) {
            ...
            if (pickdate.month <= 9 && pickdate.day <= 9) {
              widget.dateController.text =
                  '${pickdate.year}-0${pickdate.month}-0${pickdate.day}';
              widget.refreshData();
            } else if (pickdate.month <= 9 && pickdate.day >= 10) {
              widget.dateController.text =
                  '${pickdate.year}-0${pickdate.month}-${pickdate.day}';
              widget.refreshData();
            } else if (pickdate.month >= 10 && pickdate.day <= 9) {
              widget.dateController.text =
                  '${pickdate.year}-${pickdate.month}-0${pickdate.day}';
              widget.refreshData();
            } else {
              widget.dateController.text =
